...
namespace IdentityServer.UnitTests.Extensions
{
    public class IResourceStoreExtensionsTests
    {
        ...
        public async Task GetAllEnabledResourcesAsync_on_duplicate_identity_scopes_should_fail()
        {
            ...
            await a.Should().ThrowAsync<Exception>().Where(exception => exception.Message.Contains("duplicate", StringComparison.OrdinalIgnoreCase) && exception.Message.Contains("identity scopes", StringComparison.OrdinalIgnoreCase));
        }
        ...
        public async Task GetAllEnabledResourcesAsync_on_duplicate_api_resources_should_fail()
        {
            ...
            Func<Task> a = () => store.GetAllEnabledResourcesAsync();
            await a.Should().ThrowAsync<Exception>().Where(e => e.Message.Contains("duplicate", StringComparison.OrdinalIgnoreCase) && e.Message.Contains("api resources", StringComparison.OrdinalIgnoreCase));
        }
